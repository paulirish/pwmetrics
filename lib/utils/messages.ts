...
import { MessageType, MessageLevel } from '../../types/types';
...
const greenify: ((str: string) => string) = str => `${GREEN}${str}${RESET}`;
const redify: ((str: string) => string) = str => `${RED}${str}${RESET}`;
const yellowify: ((str: string) => string) = str => `${YELLOW}${str}${RESET}`;
const boldify: ((str: string) => string) = str => `${BOLD}${str}${RESET}`;

const getMessage = function(messageType: MessageType, ...args: string[]) {
  switch (messageType) {
    case 'NO_URL':
...
const getAssertionMessage = function(assertionLevel: MessageLevel, messageType: MessageType, expectedValue: number, actualValue: number) {
...
const getMessageWithPrefix = function(assertionLevel: MessageLevel, messageType: MessageType, ...args: string[]) {
  let prefix;
