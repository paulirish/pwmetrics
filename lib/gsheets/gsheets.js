...
const spreadsheetId = '1-84NpWXXBNmwkmx4tmWNzR7xnVYRhIBgVxGePA4jsZk';
 ...
 * @return {Promise}
 */
function appendResults(auth, valuesToAppend) {
  var sheets = google.sheets('v4');
  ...
  return new Promise((resolve, reject) => {
    sheets.spreadsheets.values.append({
      ...
      return getRange(auth, response.updates.updatedRange)
        .then(values => {
